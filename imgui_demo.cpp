...
static void ShowDemoWindowMenuBar(ImGuiDemoWindowData* demo_data)
{
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        // KH: Preventing any windows from being opened that aren't closable through actions
...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Dark\0Light\0Classic\0"))
    {
        switch (style_idx)
        {
        case 0: ImGui::StyleColorsDark(&GetStyle()); break;
        case 1: ImGui::StyleColorsLight(&GetStyle()); break;
        case 2: ImGui::StyleColorsClassic(&GetStyle()); break;
        }
        return true;
    }
    return false;
